...
enum autopilot_yaw_mode {
    ...
    AUTO_YAW_INTO_WIND =        7,  // CASS: turn into wind moving verticaly or steady (for vertical profiles)
    AUTO_YAW_WIND_CT2 =         8,  // CASS: point to specific vector for CT2 profiling
};
